...
@Sanity
Feature: NG App Sanity Suite
  @Login
  Scenario Outline: Verify the functionality of signup page
    ...
    Examples:
      | email | otp | username | password | confirmPassword | cardno | expiry | name | cvv |
      | RANDOM | 100000|RANDOM     |RANDOM   |RANDOM          |RANDOM          |RANDOM|RANDOM   |RANDOM |

  Scenario Outline: Verify the functionality of Forgot Password page
    Given As a user I want to open the NG Application
    ...
    Examples:
      | email       | newpassword  | otp    | username |
      | FROM DB     | RANDOM       | 100000 | FROM DB  |
  ...
  Scenario Outline: Validation of Login using "<type>"
    ...
    Examples:
      ...
      | ksaketh    | Gaian@123#  | username    |

  Scenario Outline: Verify the video streaming in failed scenario
    Given As a user I want to open the NG Application
    When User enters "<username>" in Username field
    And User enters "<password>" in Password field
    And Clicks on login button
   ...
   # Then User is able to see WalkThrough feature of the App
    ...
    Then User is unable to see the video in "HomePage" page

    Examples:
      | username                              | password   |
      | kocherla.saisaketh@gaiansolutions.com | Gaian@123# |

  Scenario Outline: Verify the video streaming in success scenario
    Given As a user I want to open the NG Application
    When User enters "<username>" in Username field
    And User enters "<password>" in Password field
    And Clicks on login button
    ...
    Examples:
      ...
      | ksaketh                               | Gaian@123# |
#
  Scenario Outline: Verify whether user is able to edit his details
    Given As a user I want to open the NG Application
    When User enters "<username>" in Username field
    And User enters "<password>" in Password field
    And Clicks on login button
    ...
    #When User clicks on Back Button on profile edit page
    ...
    Examples:
      | username      | password  | firstname | lastname | age | address |
      | ksaketh       | Gaian@123#  | sai  | saketh   | 24  | India  |

@bae2e
  Scenario Outline: Trigger API request
    Given As a user I want to open the NG Application
    When User enters "<username>" in Username field
    And User enters "<password>" in Password field
    And Clicks on login button
  ...
  Then User selects his profile after tower screen
    ...
    Then User triggers BA delivery API Call
    And User verifies if the files got uploaded to pitcher
    ...
    Examples:
      ...
      | ksaketh                                          | Gaian@123#  |
##
  Scenario Outline: Verify whether user is able to create new avatar and delete it
    Given As a user I want to open the NG Application
    When User enters "<username>" in Username field
    And User enters "<password>" in Password field
    And Clicks on login button
    ...
    And User clicks on "skip" button in the WalkThrough
    And User clicks on profile menu
    Then User is able to see his "<username>" in Profile Page and clicks on it
    ...
    Then User enters "<firstName>" as "FirstName" in create new avatar
    ...
    Examples:
      | username      | password      | firstName | newusername  |
      | ksaketh      | Gaian@123#      | sdet      |  User1      |

  Scenario Outline: Verify the functionality of User Reviews
    Given As a user I want to open the NG Application
    When User enters "<username>" in Username field
    And User enters "<password>" in Password field
    And Clicks on login button
    ...
    Examples:
      | username      | password      | userReview        |
      | ksaketh       | Gaian@123#    | Automated Review  |

#  Scenario Outline: Verify the Functionality of NextGen Store
#    Given As a user I want to open the NG Application
#    When User enters "<username>" in Username field
#    And User enters "<password>" in Password field
#    And Clicks on login button
#    Then User is navigated to Towers screen
#    When User clicks on continue button in Towers screen
#    Then User selects "<username>" in profile select section after tower screen
#    Then User is able to see WalkThrough feature of the App
#    And User clicks on "skip" button in the WalkThrough
...
#    When User selects "MB" and gets redirected to respective Screen
#    Then User launches the BroadCasting APP
#    And User clicks system back button
#    And User is navigated back by clicking back button
#    When User selects "Emoticons" and gets redirected to respective Screen
#    Then User launches the BroadCasting APP
#    And User clicks system back button
#    Then User is navigated back by clicking back button
#    When User selects "Q&A" and gets redirected to respective Screen
#    Then User launches the BroadCasting APP
#    And User clicks system back button
#    Then User is navigated back by clicking back button
#    When User selects "Responder" and gets redirected to respective Screen
#    Then User launches the BroadCasting APP
#    And User clicks system back button
#    Then User is navigated back by clicking back button
#    And User is able to see the BA List Page
#    Then User is navigated back by clicking back button
#    Then User is able to see Trending Apps, Curious Crew sections
#    And User clicks on profile menu
#    And User is able to see devices, username, logout, version, settings
...
#      | ksaketh                                          | Gaian@123# |
#
  Scenario Outline: User verifies the Seasons in VOD Page
    Given As a user I want to open the NG Application
    When User enters "<username>" in Username field
    And User enters "<password>" in Password field
    And Clicks on login button
    ...
    Then User is able to see videos under Releases in 2019 , Top rated
    When User clicks on a video on vod
#    Then User taps on "TextOfTheSeasons" in VOD Page
    ...
    And User selects Season name as "Curious Crew Season4"
    Then User is able to see the seasons DropDown and click on it
    And User selects Season name as "Curious Crew Season3"
    Then User is able to see the seasons DropDown and click on it
    ...
    And User clicks system back button
    Then User clicks on profile menu
    And User is able to see devices, username, logout, version, settings
  ...
  Scenario Outline: Check whether the app navigation is functioning properly, Video validations of VOD Page
    Given As a user I want to open the NG Application
    When User enters "<username>" in Username field
    And User enters "<password>" in Password field
    And Clicks on login button
...
#    And User click on back button on player screen
  ...
  Scenario Outline: Verify whether, the app validations are been done properly in HomePage, NextGen, LiveTv
    Given As a user I want to open the NG Application
    When User enters "<username>" in Username field
    And User enters "<password>" in Password field
    And Clicks on login button
